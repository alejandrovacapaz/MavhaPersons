<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/MasterPage.Master" CodeBehind="AddPerson.aspx.vb" Inherits="MavhaPersons.AddPerson" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">   
        <div class="text-center marginTop">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 marginTop text-center">
                <asp:Button CssClass="btn btn-success" OnClick="btnAddPerson_Click" ID="AddPerson" runat="server" Text="Adicionar" />
            </div>
